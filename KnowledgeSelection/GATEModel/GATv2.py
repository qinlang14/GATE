...
class GATv2(nn.Module):
    def __init__(self, in_dim, hidden_dim, out_dim, num_heads, mask):
        super(GATv2, self).__init__()

        self.num_heads = num_heads
        self.layer1 = GraphAttentionV2Layer(in_features=in_dim, out_features=hidden_dim, n_heads=num_heads, mask=mask)
        self.layer2 = GraphAttentionV2Layer(in_features=hidden_dim, out_features=hidden_dim, n_heads=num_heads, mask=mask)
        self.layer3 = GraphAttentionV2Layer(in_features=hidden_dim, out_features=hidden_dim, n_heads=num_heads, mask=mask)
