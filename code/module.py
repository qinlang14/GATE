...
class Environment:
    def __init__(self, opt):
        with open("{}/knowledge_base.json".format(opt["dataset"]), "r", encoding='utf-8') as f:
            self.knowledge_base = json.load(f)
        self.knowledge_embedding = torch.load("{}/knowledge_embedding.pth".format(opt["dataset"]), map_location=opt["device"])
